...
import ecommerce from "../../assets/app_development 1.png";
    ...
    <div className="OnboardingPage1 min-vh-100">
      <div className="card h-100 w-90 mx-auto">
        ...
        <div className="text-center my-3">
          <h1 className="onboardingheading">Sell Your Product</h1>
          <p className="py-3 px-4 leading-5 mx-auto font-bold text-base text-success">
            Buy & Sell your Crops to anyone from anywhere in India with Hi Kisan
            Mandi, ns P S yo
          </p>
        </div>
